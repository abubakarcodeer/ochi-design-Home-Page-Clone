...
const Footer = () => {
    return (
        <div  className='w-full relative min-h-screen bg-zinc-200 px-[5vw] rounded-xl flex flex-col'>
            <div className='w-full grid grid-cols-1 md:grid-cols-2 md:pt-0 pt-10 flex-1'>
                <div className='col-span-1'>
                    <h1 className='uppercase font-["FoundersGrotesk"] tracking-tight leading-[7vw] text-[10vw]'>eye-<br />
                        opening</h1>
                </div>
                <div className='col-span-1'>
                    <h1 className='uppercase font-["FoundersGrotesk"] tracking-tight leading-[7vw] text-[10vw]'>presentations</h1>
                    <div className='flex flex-row md:flex-col flex-wrap gap-8 mt-10 text-md underline'>
                        <div className='flex flex-col'>
                            <h1 className='pb-5 no-underline'>S:</h1>
                            <a href="">Instagram</a>
                            <a href="">Behance</a>
                            <a href="">Facebook</a>
                            <a href="">Linkedin</a>
                        ...
                        <div>
                            <h1 className='pb-5 no-underline'>E:</h1>
            ...
            <footer className='w-full flex flex-col md:flex-row gap-5 md:items-center md:justify-between p-[3vw]' >
                <a href="#">
