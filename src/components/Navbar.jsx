...
const Navbar = () => {
  ...
  const [scrolled, setScrolled] = useState(false);
    ...
    return (
        <div className={`w-full px-[4vw] py-4 z-20 fixed top-0 font-['NeueMontreal']  transition-transform duration-400 ease-in-out   ${scrolled ? "backdrop-blur" : "bg-transparent"} 
      ${hideHeader ? "-translate-y-[200px]" : "translate-y-0"}`}>
            <div>
                <div className='grid lg:grid-cols-12 gap-x-10 items-center grid-cols-7 '>
                    ...
                    <div className='col-span-6 hidden lg:flex'>
                        <ul className='flex flex-1 items-center justify-between font-normal text-md cursor-pointer'>
                            <li><a href="#services">Services</a></li>
                            <li><a href="#work">Our work</a></li>
                            <li><a href="#about">About us</a></li>
                            <li><a href="#insight">Insights</a></li>
                            <li className='ml-[12vw]'><a href="#contactme">Contact us</a></li>
                        </ul>
                    </div>
                <div className='lg:hidden col-span-1'><BiMenu size={24}/></div>
                </div>
            </div>
        </div>
    )
